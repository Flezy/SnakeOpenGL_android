 ...
 */
public class MyGLRendererForSphere implements GLSurfaceView.Renderer {
    // Ambient light
    ...
    short a = 3;
    short sector = 4;
    private Sphere mSphere = new Sphere(radius, a, sector);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig arg1) {
        ...
        plane1 = new Triangle(triangleCoords);
        plane2 = new Triangle(triangleCoords2);
